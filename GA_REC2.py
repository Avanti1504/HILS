...
gene_bounds = [
    #(1e-15, 1e-14),  # epsilon stepsize e-15
    (0.001, 0.002),  # delta (1e-4 2e-4) stepsize #initial(0.00015,0.00045)
    #(0.3, 0.8), #TOL
    #(20,40), #p1
    #(60,90) ,#p2
    
    (0.004, 0.006) ,#EPSILON_SEQ_ERROR
...
while (1/min_fitness)<2:
    ...
    desired_outputs = np.loadtxt("/mnt/e/Systems/STADS/Electrical/Puja/ParameterTuning/HILS_1/idealoutputs.txt", dtype=float)
    desired_outputs = desired_outputs.reshape(5, 4)
    #print(desired_outputs)

    # Define the C program command
    c_program_command_1 = "gcc /mnt/e/Systems/STADS/Electrical/Puja/ParameterTuning/HILS_1/main.c  -o /mnt/e/Systems/STADS/Electrical/Puja/ParameterTuning/HILS_1/exe -lm"
    c_program_command_2 = "/mnt/e/Systems/STADS/Electrical/Puja/ParameterTuning/HILS_1/exe"
...
'''
        ...
        with open("/mnt/e/Systems/STADS/Electrical/Puja/ParameterTuning/HILS_1/constants.h", "w") as file:
